...
@Tag("successAndFailedPracticeFormWithPageObjectTests")
public class SuccessAndFailedPracticeFormWithPageObjectTests extends TestBaseWithSuccessAndFailedPageObject {
    ...
    @Test
    void failedStateTestPracticeForm() {
